...
100.times {
Flight.create(origin: "#{airport_codes[rand airport_codes.count]}", destination: "#{airport_codes[rand airport_codes.count]}", seat: 250, departure: Time.now + 5.days, arrival: Time.now + 5.days + 50.minutes, airline: "Chinese Airlines", flight_code: "MFM12", flight_type: "Local", flight_cost: 200, status: "Booking")
...
Flight.create(origin: "#{airport_codes[rand airport_codes.count]}", destination: "#{airport_codes[rand airport_codes.count]}", seat: 250, departure: Time.now + 5.days, arrival: Time.now + 5.days + 8.hours, airline: "Arik Air", flight_code: "MFM27", flight_type: "International", flight_cost: 900, status: "Cancelled")
Flight.create(origin: "#{airport_codes[rand airport_codes.count]}", destination: "#{airport_codes[rand airport_codes.count]}", seat: 250, departure: Time.now + 3.days, arrival: Time.now + 3.days + 6.hours, airline: "Chinese Airlines", flight_code: "MFM23", flight_type: "International", flight_cost: 900, status: "Cancelled")
